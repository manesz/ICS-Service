...
ZeroClipboard_TableTools.Client.prototype = {id: 0, ready: !1, movie: null, clipText: "", fileName: "", action: "copy", handCursorEnabled: !0, cssEffects: !0, handlers: null, sized: !1, glue: function (a, b) {
    ...
    if (navigator.userAgent.match(/MSIE/))var e = baseUrl/*location.href.match(/^https/i) ? "https://" : "http://"*/, c = c + ('<object classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" codebase="' + e + 'download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=10,0,0,0" width="' + a + '" height="' + b + '" id="' + this.movieId + '" align="middle"><param name="allowScriptAccess" value="always" /><param name="allowFullScreen" value="false" /><param name="movie" value="' +
...
(function (f, n, g) {
    ...
    TableTools.prototype = {fnGetSelected: function (a) {
        ...
        fnResizeRequired: function () {
            ...
            this.s.swfPath = baseUrl + "assets/js/plugins/datatable/swf/copy_csv_xls_pdf.swf";//this.s.custom.sSwfPath;
    ...
    TableTools.DEFAULTS = {sSwfPath: baseUrl + "assets/js/plugins/datable/swf/copy_csv_xls_pdf.swf", sRowSelect: "none", sSelectedClass: null, fnPreRowSelect: null, fnRowSelected: null, fnRowDeselected: null, aButtons: ["copy", "csv", "xls", "pdf", "print"], oTags: {container: "div", button: "a", liner: "span", collection: {container: "div", button: "a", liner: "span"}}};
