        ...
        $(".plupload").each(function () {
            ...
            $el.pluploadQueue({
                ...
                filters: [
                    ...
                    {title: "Media files", extensions: "avi,mp4,3gp"},
        ...
        $('.dataTable').each(function () {
            if (!$(this).hasClass("dataTable-custom")) {
                ...
                if ($(this).hasClass('dataTable-tools')) {
                    opt.sDom = "T" + opt.sDom;
                    opt.oTableTools = {
                        "sSwfPath": baseUrl + "assets/js/plugins/datatable/swf/copy_csv_xls_pdf.swf"
                    };
                }
                if ($(this).hasClass("dataTable-scroller")) {
                    ...
                    opt.sAjaxSource = baseUrl + "assets/js/plugins/datatable/demo.txt";
                }
