...
<div id="messageDeleteData" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;">
    ...
    <div class="modal-footer">
        ...
        <button class="btn btn-primary" data-dismiss="modal" onclick="deleteData();">Yes</button>
    </div>
</div>